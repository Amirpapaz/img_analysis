...
export default function ImageDisplay(props) {
  ...
  return (
   ...
   {loading ? (<i className="fa-solid fa-spinner loadingState"></i>) : (<p className="flex specialBtn px-4 py-2 font-bold rounded-xl items-center text-base justify-between gap-4 mx-auto  max-w-full my-4 specialBtn"> {result} </p>)}
